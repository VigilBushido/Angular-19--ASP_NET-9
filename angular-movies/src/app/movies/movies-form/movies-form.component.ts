...
@Component({
  ...
  imports: [NzIconModule, NzButtonModule, ReactiveFormsModule, NzFormModule, NzInputModule, NzDatePickerModule, FormsModule, InputImgComponent, RouterLink, MultipleSelectorComponent, ActorsAutocompleteComponent],
